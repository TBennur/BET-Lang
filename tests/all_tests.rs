...
success_tests! {
    ...
    // Tests we gave students
    {
        ...
        file: "cobra-bet/false_val.bet",
        expected: "false",
    },
    {
        name: cobra_example1,
        file: "cobra-bet/example1.bet",
        expected: "6",
    },
    {
        name: cobra_example2,
        file: "cobra-bet/example2.bet",
        expected: "-6",
    },
    {
        name: cobra_factorial0,
        file: "cobra-bet/factorial.bet",
        input: "0",
        expected: "1",
    },
    {
    ...
    },
    {
        ...
        file: "cobra-bet/input_compare.bet",
        input: "2",
        expected: "false",
    },
    {
    ...
    {
        name: boa_add1,
        file: "boa-bet/add1.bet",
        expected: "73",
    },
    {
        name: boa_add1_sub1,
        file: "boa-bet/add1_sub1.bet",
        expected: "4",
    },
    {
        name: cobra_add_num,
        file: "cobra-bet/add.bet",
        input: "10",
        expected: "15",
    },
    ...
    // Nested Arithmetic Expressions
    {
        ...
        file: "boa-bet/nested_arith0.bet",
        expected: "35",
    },
    {
        name: boa_nested_arith1,
        file: "boa-bet/nested_arith1.bet",
        expected: "25",
    },
    {
        name: boa_nested_arith2,
        file: "boa-bet/nested_arith2.bet",
        expected: "0",
    },
    {
        name: boa_nested_arith3,
        file: "boa-bet/nested_arith3.bet",
        input: "8",
        expected: "1117",
    },
    {
        name: boa_nested_arith4,
        file: "boa-bet/nested_arith4.bet",
        expected: "-1",
    },
    ...
    // Comparison Expressions
    {
        ...
        file: "cobra-bet/equals_bool.bet",
        expected: "true",
    },
    {
        name: cobra_compare_expr_succ0,
        file: "cobra-bet/compare_expr_succ0.bet",
        expected: "true",
    },

    {
        name: cobra_compare_expr_succ2,
        file: "cobra-bet/compare_expr_succ2.bet",
        expected: "true",
    },
    ...
    {
        name: cobra_binding0,
        file: "cobra-bet/binding0.bet",
        expected: "5",
    },
    {
        name: cobra_binding1,
        file: "cobra-bet/binding1.bet",
        expected: "-5",
    },

    {
        name: cobra_binding_expr,
        file: "cobra-bet/binding_expr.bet",
        expected: "1225",
    },
    {
        name: boa_binding_nested,
        file: "boa-bet/binding_nested.bet",
        expected: "1",
    },

    {
        name: cobra_binding_chain,
        file: "cobra-bet/binding_chain.bet",
        expected: "3",
    },
    {
        name: cobra_binding_nested_chain,
        file: "cobra-bet/binding_nested_chain.bet",
        expected: "12",
    },
    ...
    // Let expressions with shadowing
    {
        ...
        file: "boa-bet/shadowed_binding_succ0.bet",
        expected: "100",
    },
    {
        name: boa_shadowed_binding_succ1,
        file: "boa-bet/shadowed_binding_succ1.bet",
        expected: "7",
    },
    {
        name: boa_shadowed_binding_succ2,
        file: "boa-bet/shadowed_binding_succ2.bet",
        expected: "150",
    },
    {
        name: boa_shadowed_binding_succ3,
        file: "boa-bet/shadowed_binding_succ3.bet",
        expected: "5",
    },
    {
        name: boa_shadowed_binding_succ4,
        file: "boa-bet/shadowed_binding_succ4.bet",
        expected: "18",
    },
    {
        name: boa_shadowed_binding_succ5,
        file: "boa-bet/shadowed_binding_succ5.bet",
        expected: "5",
    },
    {
        name: boa_shadowed_binding_succ6,
        file: "boa-bet/shadowed_binding_succ6.bet",
        expected: "3",
    },
    {
        name: boa_shadowed_binding_succ7,
        file: "boa-bet/shadowed_binding_succ7.bet",
        expected: "200",
    },
    ...
    // Misc complex expressions with arithmetic and let bindings
    {
        ...
        file: "boa-bet/complex_expr.bet",
        expected: "6",
    },
    {
        name: boa_quick_brown_fox,
        file: "boa-bet/quick_brown_fox.bet",
        expected: "-3776",
    },
    ...
    // If expressions
    {
        ...
        file: "cobra-bet/if_expr_succ2.bet",
        expected: "8",
    },
    {
        name: cobra_if_expr_succ3,
        file: "cobra-bet/if_expr_succ3.bet",
        expected: "7",
    },
    ...
    // Set expr
    {
        ...
        file: "cobra-bet/set_expr1.bet",
        expected: "10",
    },
    {
        name: cobra_set_expr_succ1,
        file: "cobra-bet/set_expr2.bet",
        expected: "true",
    },
    {
        name: cobra_set_expr_succ2,
        file: "cobra-bet/set_expr3.bet",
        input: "25",
        expected: "true",
    },
    {
    ...
    // Unit Tests
    {
        ...
        file: "cobra-bet/input_plus1.bet",
        input: "10",
        expected: "11",
    },
    {
    ...
    {
        name: cobra_true_val,
        file: "cobra-bet/true_val.bet",
        expected: "true",
    },
    {
        name: cobra_negative_one_val,
        file: "cobra-bet/negative_one_val.bet",
        expected: "-1",
    },
    {
        name: cobra_zero_val,
        file: "cobra-bet/zero_val.bet",
        expected: "0",
    },
    {
        name: cobra_one_val,
        file: "cobra-bet/one_val.bet",
        expected: "1",
    },
    {
        name: cobra_five_val,
        file: "cobra-bet/five_val.bet",
        expected: "5",
    },
    {
        name: cobra_compare_greater_1,
        file: "cobra-bet/compare_greater.bet",
        input: "6",
        expected: "true",
    },
    {
    ...
    },
    {
        ...
        file: "cobra-bet/compare_greater_equal.bet",
        input: "6",
        expected: "true",
    },
    {
    ...
    },
    {
        ...
        file: "cobra-bet/compare_equal.bet",
        input: "6",
        expected: "false",
    },
    {
    ...
    },
    {
        ...
        file: "cobra-bet/compare_less_equal.bet",
        input: "6",
        expected: "false",
    },
    {
    ...
    },
    {
        ...
        file: "cobra-bet/compare_less.bet",
        input: "6",
        expected: "false",
    },
    {
    ...
    },
    {
        ...
        file: "cobra-bet/equal_bool.bet",
        expected: "true",
    },
   {
        name: cobra_not_equal_bool,
        file: "cobra-bet/not_equal_bool.bet",
        expected: "false",
    },
    {
        name: cobra_good_set,
        file: "cobra-bet/good_set.bet",
        expected: "6",
    },
    {
        name: cobra_basic_block,
        file: "cobra-bet/basic_block.bet",
        expected: "3",
    },
    {
        name: cobra_nested_loops_1,
        file: "cobra-bet/nested_loops.bet",
        input: "1",
        expected: "1",
    },
    {
    ...
    // Ensemble Tests
    {
        ...
        file: "cobra-bet/just_input.bet",
        input: "-9223372036854775808",
        expected: "-9223372036854775808",
    },
    {
        name: cobra_equal_bool_compound,
        file: "cobra-bet/equal_bool_compound.bet",
        expected: "true",
    },
    {
        name: cobra_equal_bool_let,
        file: "cobra-bet/equal_bool_let.bet",
        expected: "true",
    },
    {
        name: cobra_if_nested,
        file: "cobra-bet/if_nested.bet",
        expected: "5",
    },
    {
        name: cobra_if_let,
        file: "cobra-bet/if_let.bet",
        expected: "5",
    },
    {
    ...
    },
    {
        ...
        file: "diamondback-bet/print_int.bet",
        expected: "5\n5",
    },
    {
        name: diamondback_print_bool,
        file: "diamondback-bet/print_bool.bet",
        expected: "true\ntrue",
    },
    {
        name: diamondback_print_test,
        file: "diamondback-bet/print_test.bet",
        input: "3",
        expected: "5\n4\n3\n3",
    },
    {
        name: diamondback_let_print,
        file: "diamondback-bet/let_print_test.bet",
        expected: "5\n5",
    },
    {
        name: diamondback_sophia_test,
        file: "diamondback-bet/sophia_test.bet",
        expected: "243\n244",
    },
    {
        name: diamondback_fact_5,
        file: "diamondback-bet/fact.bet",
        input: "5",
        expected: "120"
    },
    {
    ...
    },
    {
        ...
        file: "diamondback-bet/even_odd_one_print.bet",
        input: "1",
        expected: "false"
    },
    {
    ...
    },
    {
        ...
        file: "diamondback-bet/even_odd.bet",
        input: "1000",
        expected: "1000\ntrue\ntrue"
    },
    {
        name: diamondback_fib_1,
        file: "diamondback-bet/fib.bet",
        input: "2",
        expected: "1\n1\n2"
    },
    {
    ...
    },
    {
        ...
        file: "diamondback-bet/many_args.bet",
        input: "5",
        expected: "760"
    },
    {
        name: diamondback_add_up_1,
        file: "diamondback-bet/add_up.bet",
        input: "1",
        expected: "1"
    },
    {
    ...
    },
    {
        ...
        file: "diamondback-bet/print_up_to.bet",
        input: "2",
        expected: "1\n1\n2\n4"
    },
    {
    ...
    },
    {
        ...
        file: "diamondback-bet/fun_nested_call.bet",
        input: "20",
        expected: "2100",
    },
    {
        name: diamondback_fun_two_args,
        file: "diamondback-bet/fun_two_args.bet",
        expected: "25",
    },
    {
        name: diamondback_fun_many_args,
        file: "diamondback-bet/fun_many_args.bet",
        input: "-1",
        expected: "2147483648",
    },
    {
        name: diamondback_fun_many_calls,
        file: "diamondback-bet/fun_many_calls.bet",
        input: "5",
        expected: "0\n5\n10\n15\n20\n25\n0",
    },
    ...
    },
    {
        ...
        file: "diamondback-bet/fun_no_args.bet",
        expected: "true\nfalse\n0\n-1\n1",
    },
    {
        name: diamondback_calling_chain0,
        file: "diamondback-bet/calling_chain0.bet",
        expected: "100\n100",
    },
    {
        name: diamondback_calling_chain1,
        file: "diamondback-bet/calling_chain1.bet",
        expected: "100\n100",
    },
    {
        name: diamondback_conveyer_belt,
        file: "diamondback-bet/conveyer_belt.bet",
        expected: "-50"
    },
    {
        name: diamondback_decreasing_args,
        file: "diamondback-bet/decreasing_args.bet",
        expected: "12"
    },
    {
        name: diamondback_many_unused_functions,
        file: "diamondback-bet/many_unused_functions.bet",
        input: "42",
        expected: "84",
    },
    // More complex recursive functions
    {
        ...
        file: "diamondback-bet/recursive_ackermann.bet",
        expected: "61",
    },
    {
        name: diamondback_recursive_factorial,
        file: "diamondback-bet/recursive_factorial.bet",
        expected: "1\n1\n2\n6\n24\n120\n720\n5040",
    },
    {
        name: diamondback_recursive_fibonacci,
        file: "diamondback-bet/recursive_fibonacci.bet",
        expected: "55",
    },
    ...
    // Egg Eater Tests
    {
        ...
        file: "eggeater-bet/alloc_zero_test.bet",
        expected: "0",
    },
    {
        name: eggeater_null_comparison,
        file: "eggeater-bet/null_comparison.bet",
        expected: "false",
    },
    {
        name: eggeater_null_equality,
        file: "eggeater-bet/null_equality.bet",
        expected: "true",
    },
    {
        name: eggeater_recursive_structure,
        file: "eggeater-bet/recursive_structure.bet",
        expected:"1\n2"
    },
    {
        name: eggeater_simple_examples,
        file: "eggeater-bet/simple_examples.bet",
        expected:"1\n2\n2"
    },
    {
        name: eggeater_points,
        file: "eggeater-bet/points.bet",
        expected:"4\n16\n6\n18\n8\n20"
    },
    {
        name: eggeater_bst,
        file: "eggeater-bet/bst.bet",
...
runtime_error_tests! {
    ...
    // integer overflow
    {
        ...
        file: "diamondback-bet/add.bet",
        input: "9223372036854775803",
        expected: "overflow",
    },
    {
        name: diamondback_number_overflow_fail3,
        file: "diamondback-bet/nested_arith3.bet",
    ...
    // New to Eggeater
    {
        ...
        file: "eggeater-bet/allocator_overflow_error_fail.bet",
        expected: "out of space",
    },
    {
        name: eggeater_update_null_dereference_fail,
        file: "eggeater-bet/update_null_dereference_fail.bet",
        expected: "null dereference",
    },
    {
        name: eggeater_lookup_null_dereference_fail,
        file: "eggeater-bet/lookup_null_dereference_fail.bet",
        expected: "null dereference",
    },
    {
        name: eggeater_update_null_fail,
        file: "eggeater-bet/update_null_fail.bet",
        expected: "null dereference",
    },
    {
        name: eggeater_lookup_null_fail,
        file: "eggeater-bet/lookup_null_fail.bet",
        expected: "null dereference",
    },
}
...
static_error_tests! {
    {
        ...
        file: "diamondback-bet/input_set_fail.bet",
        expected: "keyword"
    },

    {
        name: cobra_invalid_argument,
        file: "cobra-bet/invalid_argument.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_add1,
        file: "cobra-bet/invalid_argument_add1.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_greater,
        file: "cobra-bet/invalid_argument_greater.bet",
        expected: "mismatch",
    },
        {
        name: cobra_invalid_argument_equal,
        file: "cobra-bet/invalid_argument_equal.bet",
        expected: "mismatch",
    },
    {
        name: cobra_number_bounds_fail,
        file: "cobra-bet/number_bounds_fail.bet",
        expected: "Invalid",
    },
    {
        name: cobra_failed_set,
        file: "cobra-bet/failed_set.bet",
        expected: "mismatch",
    },
    {
        name: diamondback_duplicate_params,
        file: "diamondback-bet/duplicate_params.bet",
    ...
    // Our Egg Eater Tests
    {
        ...
        file: "eggeater-bet/duplicate_fun_struct_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_alloc_nonexistent_struct,
        file: "eggeater-bet/alloc_nonexistent_struct_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_duplicate_struct,
        file: "eggeater-bet/duplicate_struct_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_duplicate_field,
        file: "eggeater-bet/duplicate_field_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_empty_struct,
        file: "eggeater-bet/empty_struct_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_if_type_mismatch,
        file: "eggeater-bet/if_type_mismatch_fail.bet",
        expected: "mismatch",
    },
    {
        name: eggeater_invalid_update_field,
        file: "eggeater-bet/invalid_update_field_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_lookup_nonexistent,
        file: "eggeater-bet/lookup_nonexistent_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_lookup_nonpointer,
        file: "eggeater-bet/lookup_nonpointer_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_invalid_field_type,
        file: "eggeater-bet/invalid_field_type_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_null_lookup_compile,
        file: "eggeater-bet/null_lookup_comp_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_bad_null,
        file: "eggeater-bet/set_null_fail.bet",
        expected: "keyword",
    },
    {
        name: eggeater_struct_null,
        file: "eggeater-bet/set_struct_fail.bet",
        expected: "mismatch",
    },
    {
        name: eggeater_null_int_ptr,
        file: "eggeater-bet/null_int_ptr.bet",
        expected: "keyword",
    },

    {
        name: eggeater_update_nonexistent,
        file: "eggeater-bet/update_nonexistent_fail.bet",
        expected: "Invalid",
    },
    {
        name: eggeater_update_nonpointer,
        file: "eggeater-bet/update_nonpointer_fail.bet",
        expected: "Invalid",
    },
    ...
    // Type errors
    {
        ...
        file: "cobra-bet/if_expr_succ0.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail8,
        file: "cobra-bet/if_expr_input.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail0,
        file: "cobra-bet/invalid_argument_fail0.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail1,
        file: "cobra-bet/invalid_argument_fail1.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail2,
        file: "cobra-bet/invalid_argument_fail2.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail3,
        file: "cobra-bet/invalid_argument_fail3.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail4,
        file: "cobra-bet/invalid_argument_fail4.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail6,
        file: "cobra-bet/invalid_argument_fail6.bet",
        expected: "mismatch",
    },
    {
        name: cobra_invalid_argument_fail11,
        file: "cobra-bet/invalid_argument_fail11.bet",
        expected: "mismatch",
    },
    // Invalid S-expressions
    {
        name: cobra_parse_sexp_fail2,
        file: "cobra-bet/parse_sexp_fail2.bet",
        expected: "Invalid",
    },
    ...
    // Invalid tokens/operators
    {
        ...
        file: "cobra-bet/parse_token_fail1.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_token_fail2,
        file: "cobra-bet/parse_token_fail2.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_token_fail3,
        file: "cobra-bet/parse_token_fail3.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_token_fail4,
        file: "cobra-bet/parse_token_fail4.bet",
        expected: "Invalid",
    },
    ...
    // Invalid/Out of bounds Number Literal
    {
        ...
        file: "cobra-bet/number_bounds_fail0.bet",
        expected: "Invalid",
    },
    {
        name: cobra_number_bounds_fail1,
        file: "cobra-bet/number_bounds_fail1.bet",
        expected: "Invalid",
    },
    ...
    // Invalid operator arguments
    {
        ...
        file: "cobra-bet/parse_op_fail1.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_op_fail3,
        file: "cobra-bet/parse_op_fail3.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_op_fai4,
        file: "cobra-bet/parse_op_fail4.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_op_fail6,
        file: "cobra-bet/parse_op_fail6.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_op_fail7,
        file: "cobra-bet/parse_op_fail7.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_op_fail8,
        file: "cobra-bet/parse_op_fail8.bet",
        expected: "Invalid",
    },
    ...
    // Invalid let expressions
    {
        ...
        file: "cobra-bet/parse_let_nobindings_fail.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_let_improperargs_fail3,
        file: "cobra-bet/parse_let_improperargs_fail3.bet",
        expected: "Invalid",
    },
    {
        name: cobra_parse_let_improperargs_fail5,
        file: "cobra-bet/parse_let_improperargs_fail5.bet",
        expected: "keyword",
    },

    {
        name: boa_duplicate_binding_fail0,
        file: "boa-bet/duplicate_binding_fail0.bet",
        expected: "Duplicate binding",
    },
    {
        name: boa_duplicate_binding_fail1,
        file: "boa-bet/duplicate_binding_fail1.bet",
        expected: "Duplicate binding",
    },
    {
        name: boa_duplicate_binding_fail2,
        file: "boa-bet/duplicate_binding_fail2.bet",
        expected: "Duplicate binding",
    },
    ...
    // Invalid if expressions
    {
        ...
        file: "cobra-bet/parse_if_fail1.bet",
        expected: "Invalid",
    },
    ...
    // Invalid block
    {
        ...
        file: "cobra-bet/parse_block_fail0.bet",
        expected: "Invalid",
    },
    ...
    // Invalid break
    {
        ...
        file: "cobra-bet/invalid_break_fail0.bet",
        expected: "break",
    },
    ...
    // Invalid loop
    {
        ...
        file: "cobra-bet/invalid_loop_fail0.bet",
        expected: "Invalid",
    }
