...
success_tests! {
    ...
    },
   {
    ...
    },
    {
        ...
        file: "diamondback/fun_many_args.snek",
        input: "-1",
        expected: "2147483648",
    },
    {
        name: diamondback_fun_many_calls,
        file: "diamondback/fun_many_calls.snek",
        input: "5",
        expected: "0\n5\n10\n15\n20\n25\n0",
    },
    ...
    },
    {
        ...
        file: "diamondback/fun_no_args.snek",
        expected: "true\nfalse\n0\n-1\n1",
    },
    {
        name: diamondback_calling_chain0,
        file: "diamondback/calling_chain0.snek",
        expected: "100\n100",
    },
    {
        name: diamondback_calling_chain1,
        file: "diamondback/calling_chain1.snek",
        expected: "100\n100",
    },
    {
        name: diamondback_conveyer_belt,
        file: "diamondback/conveyer_belt.snek",
        expected: "-50"
    },
    {
        name: diamondback_decreasing_args,
        file: "diamondback/decreasing_args.snek",
        expected: "12"
    },
    {
        name: diamondback_many_unused_functions,
        file: "diamondback/many_unused_functions.snek",
        input: "42",
        expected: "84",
    },
    // More complex recursive functions
    {
        ...
        file: "diamondback/recursive_ackermann.snek",
        expected: "61",
    },
    {
        name: diamondback_recursive_factorial,
        file: "diamondback/recursive_factorial.snek",
        expected: "1\n1\n2\n6\n24\n120\n720\n5040",
    },
    {
        name: diamondback_recursive_fibonacci,
        file: "diamondback/recursive_fibonacci.snek",
        expected: "55",
    },
